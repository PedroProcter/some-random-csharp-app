...
namespace CapaDatos
{
    public class Datos
    {
        ...
        private static string StringConnectionSQLServer = ConfigurationManager.ConnectionStrings["WindowsFormsApp.Properties.Settings.SellPointConnectionString"].ConnectionString;
        SqlDataReader leer;
